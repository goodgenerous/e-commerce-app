      ...
      <div>
        ...
        >
          <div className="mx-auto max-w-5xl py-32 sm:py-48 lg:py-56">
            <h1 className="text-4xl font-bold tracking-tight text-slate-100 sm:text-6xl font-raleway text-center">
            ...
            <div className="grid lg:grid-cols-3 mt-5 justify-items-center">
              {dataCard.map((res) => {
                return (
                  <div className="card backdrop-blur-md bg-white/20 w-72 shadow-xl">
                    ...
                    <div className="card-body text-start text-white">
                      ...
                      <div className="card-actions justify-start mt-3">
                        <ButtonComponent name="white" title="Buy Now" link="" />
                      </div>
                    </div>
                  </div>
                );
